...
function M.help_lines()
  ...
  table.insert(lines, "  <CR>        accept whichever side (ours/theirs) the cursor is on")
  table.insert(lines, "  <leader>mo  accept ours for the hunk under the cursor")
  table.insert(lines, "  <leader>mt  accept theirs for the hunk under the cursor")
  table.insert(lines, "  <leader>mb  accept both (ours then theirs)")
  table.insert(lines, "  <leader>mn  jump to next conflict")
  table.insert(lines, "  <leader>mp  jump to previous conflict")
  table.insert(lines, "  <leader>mw  run the wand on this file (buffer, not disk)")
  table.insert(lines, "  <leader>md  toggle the ours | result | theirs diff view")
